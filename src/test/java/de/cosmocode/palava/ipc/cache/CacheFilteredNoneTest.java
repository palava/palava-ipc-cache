 ...
 * with the filter mode {@link FilterMode#NONE}.
 */
public final class CacheFilteredNoneTest extends AbstractCacheTest {

    private CacheFilter filter;
    private CommandCacheService service;
    private final IpcCommand command;

    public CacheFilteredNoneTest() {
    ...
    /**
     * Verifies that command passes the filters if no scope variables or arguments are set.
     */
    @Test
    public void passedNoScope() {
        setupNoArguments();
        assertCached();
    }

    /**
     * Verifies that the command passes the filters with the wrong language set in call context.
     */
    @Test
    public void passedWrongLocale() {
        initScopes();
        setupNoArguments();
    ...
    /**
     * Verifies that the command is not cached if the right language is set in call context.
     */
    @Test
    ...
    /**
     * Verifies that the command is not cached if the right arguments are set.
     */
    @Test
